<script lang="ts">
  ...
  const questions = [
    new Question(
      "Who is this for?",
      "Teachers who wants to randomly assign students to seats or groups",
    ),
    new Question(
...
<div class="hero min-h-[60vh]">
  <div class="hero-content text-center py-12">
    <div class="max-w-xl">
      <div
        class="text-xl md:text-xl font-bold bg-clip-text px-2 text-transparent bg-gradient-to-r from-primary to-accent mb-20"
        style="line-height: 1.2;"
      >
        Student randomizer
      </div>
      <div
        class="text-2xl md:text-5xl font-bold px-2 mb-20"
        style="line-height: 1.2;"
      >
      ...
      <div class="flex justify-center mt-20 items-center text-sm">
        ...
        {#if $themeStore === "darktheme"}
          <a href="https://www.producthunt.com" target="_blank"
            ><img
              style="width: 175px;"
              src="/images/product-hunt-logo-horizontal-orangewhite.png"
        ...
        {:else}
          <img
            style="width: 175px;"
            src="/images/product-hunt-logo-horizontal-orange.png"
            alt="Product Hunt Logo"
          />
        {/if}
      </div>
