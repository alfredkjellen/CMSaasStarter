  ...
  <div class="navbar bg-base-100">
    <div class="flex-1">
      <a class="btn btn-ghost normal-case text-xl" href="/">
        <img class="w-10" src="images/logo-8.png" alt="Logo" />
        Student randomizer</a
      >

      <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-sm">
        <li class="md:mx-1">
          <a href="/randomizeroom"
            ><svg
    ...
    <div class="flex-none">
      <ul class="menu menu-horizontal px-1 hidden sm:flex font-bold text-sm">
        <li class="md:mx-1"><a href="/pricing">Pricing</a></li>
        <li class="md:mx-1"><a href="/account">Account</a></li>
